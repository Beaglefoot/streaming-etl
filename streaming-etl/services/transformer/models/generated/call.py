...
#   filename:  http://localhost:8081/subjects/app-db.public.call-value/versions/latest/schema
#   timestamp: 2022-04-29T14:52:45+00:00
...
class BeforeItem(BaseModel):
    start_time: Optional[int] = Field(0, title='io.debezium.time.MicroTimestamp')
    end_time: Optional[Optional[int]]
    call_id: Optional[int] = 0
...
class AppDbPublicCallEnvelope(BaseModel):
    op: Optional[str]
