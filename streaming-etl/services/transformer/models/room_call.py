...
#   filename:  http://localhost:8081/subjects/app-db.public.room_call-value/versions/latest/schema
#   timestamp: 2022-04-25T15:38:10+00:00
...
class AppDbPublicRoomCallEnvelope(BaseModel):
    op: Optional[str]
